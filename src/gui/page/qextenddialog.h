 ...
 *
 * Note that the QExtendDialog will animate a button press
 ...
 *
 * \code
 *   QExtendDialog *dialog = new QExtendDialog( this );
 *   dialog->setCaption( "My title" );
 *   dialog->setButtons( QExtendDialog::Ok | QExtendDialog::Cancel | QExtendDialog::Apply );
 *
 ...
 * and many of KDE core applications use the QExtendDialog so for more
...
class NEUROSUITE_EXPORT QExtendDialog : public QDialog
{
    Q_OBJECT
    Q_ENUMS(ButtonCode)
    Q_DECLARE_PRIVATE(QExtendDialog)
  ...
  public:
    enum ButtonCode
    {
        ...
        No = 0x00000080,       ///< Show No button. (this button closes the dialog and sets the result to QExtendDialog::No)
        Yes = 0x00000100,      ///< Show Yes button. (this button closes the dialog and sets the result to QExtendDialog::Yes)
  ...
  public:
     ...
     * @p setWindowTitle(QExtendDialog::makeStandardCaption(yourCaption));
     *
     ...
     * be applied to.
     *
     * If using a QExtendDialog or KMainWindow subclass, call setCaption instead and
  ...
  Q_SIGNALS:
     ...
     */
    void buttonClicked(QExtendDialog::ButtonCode button);
  ...
  protected Q_SLOTS:
     ...
     * an own dialog;
     * @code
     * class MyDialog : public QExtendDialog {
     *     protected Q_SLOTS:
     *         virtual void slotButtonClicked(int button) {
     *             if (button == QExtendDialog::Ok)
     *                 accept();
     *             else
     *                 QExtendDialog::slotButtonClicked(button);
     *         }
     * }
     * @endcode
     *
     * @param button is the type @a QExtendDialog::ButtonCode
     */
    virtual void slotButtonClicked(int button);
     ...
     *
     * @deprecated QExtendDialog respects the style's margins and spacings automatically. Calling
...
Q_DECLARE_OPERATORS_FOR_FLAGS(QExtendDialog::CaptionFlags)
