...
Developed by Lynn Hazan (main developer), Montel Laurent (qt3 to qt4/5 porting), David Faure (qt3 to qt4/5 porting), Michaël Zugaro (plugins, maintenance), Florian Franzen (maintenance) and Joscha Schmiedt (qt5 to qt6 porting), distributed under the GNU Public License v2.

**Note:** The port to Qt6 is still in progress.
